...
*   一、[WEB理论](#a0)
    * [各大浏览器的内核分别是什么](#a1)
    * [介绍一下你对浏览器内核的理解？](#a2)
    * [前端页面有哪三层构成，分别是什么？作用是什么？](#a3)
    * [讲讲输入完网址按下回车，到看到网页这个过程中发生了什么](#a4)
    * [谈谈你对前端性能优化的理解](#a5)
    * [请说出三种减少页面加载时间的方法](#a6)
    * [列举IE与其他浏览器不一样的特性？](#a7)
    * [一个页面上有大量的图片（大型电商网站），加载很慢，你有哪些方法优化这些图片的加载，给用户更好的体验。](#a8)
    * [网站重构的理解](#a9)
    * [谈谈对“回流”的理解](#a10)
    * [线程与进程的区别](#a11)
    * [网页验证码是干嘛的，是为了解决什么安全问题。](#a12)
    * [什么是“前端路由”什么时候适合使用“前端路由” “前端路由”有哪些优点和缺点](#a13)
    * [谈谈对前端模块化的理解](#a14)
    * [移动端的点击事件的有延迟，时间是多久，为什么会有？](#a15)
    * [你如何对网站的文件和资源进行优化](#a16)
    * [请介绍一下渐进增强和优雅降级？](#a17)
    * [什么是盒子模型？](#a18)
    * [一个页面从输入 URL 到页面加载显示完成，这个过程中都发生了什么？（流程说的越详细越好）](#a19)
    * [是否了解公钥加密和私钥加密。](#a20)

*  二、[HTML+CSS](#b0)
    * [请解释一下什么是语义化的HTML。](#b1)
    * [HTML与XHTML——二者有什么区别](#b2)
    * [img标签上title属性与alt属性的区别是什么？](#b3)
    * [如果设计中使用了非标准的字体，你该如何去实现？](#b4)
    * [每个HTML文件里开头都有个很重要的东西，Doctype，知道这是干什么的吗？](#b5)
    * [你知道多少种Doctype文档类型？](#b6)
    * [Doctype作用严格模式与混杂模式如何区分？它们有何意义](#b7)
    * [简述一下src与href的区别](#b8)
    * [请阐述table的缺点](#b9)
    * [分别写出以下几个HTML标签：文字加粗、下标、居中、字体](#b10)
    * [iframe的优缺点？](#b11)
    * [行内元素有哪些？块级元素有哪些？空void元素有那些？](#b12)
    * [CSS中link和@import的区别是什么？](#b13)
    * [对WEB标准以及W3C的理解与认识？](#b14)
    * [说下行内元素和块级元素的区别行内块元素的兼容性使用](#b15)
    * [为什么要初始化CSS样式？](#b16)
    * [有哪项方式可以对一个DOM设置它的CSS样式？](#b17)
    * [什么是FOUC[无样式内容闪烁]？你如何来避免FOUC？](#b18)
    * [:link、:visited、:hover、:active的执行顺序是怎么样的？](#b19)
    * [rgba()和opacity的透明效果有什么不同？](#b20)
    * [display:none和visibility:hidden的区别？](#b21)
    * [对BFC规范的理解](#b22)
    * [css的基本语句构成是](#b23)
    * [请简述CSS的权重规则](#b24)
    * [CSS优先级算法如何计算？](#b25)
    * [css属性content有什么作用？有什么应用？](#b26)
    * [line-height三种赋值方式有何区别？（带单位、纯数字、百分比）](#b27)
    * [position包含几种属性？absolute和relative的区别？](#b28)
    * [position的absolute与fixed共同点与不同点](#b29)
    * [请列举几种隐藏元素的方法](#b30)
    * [css如何让一段文本中的所有英文单词的首字母大写](#b31)
    * [请列举几种可以清除浮动的方法](#b32)
    * [浏览器是怎样解析CSS选择器的？](#b33)
    * [请简述CSS样式表继承](#b34)
    * [在CSS样式中常使用px、em，各有什么优劣，在表现上有什么区别](#b35)
    * [什么是外边距重叠？重叠的结果是什么](#b36)
    * [CSS中类class和ID的区别。](#b37)
    * [请解释浮动 (Float) 及其工作原理。](#b38)
    * [CSS伪类与CSS伪对象的区别](#b39)
    * [列出display的值，说明他们的作用](#b40)
    * [box-sizing常用的属性有哪些分别有什么作用](#b41)
    * [css中可继承的属性有哪些？](#b42)
    * [如何解决img下的留白？](#b43)
    * [如何居中div](#b44)
    * [什么是CSSHack](#b45)
    * [当float和margin同时使用时，IE6的双倍边距BUG如何解决](#b46)
    * [请简述CSS的选择器](#b47)
    * [经常遇到的浏览器兼容性有哪些？](#b48)
    * [浮动元素引起的问题](#b49)
    * [如何使得文字不换行](#b50)
    * [用纯CSS创建一个三角形的原理是什么？](#b51)
    * [让页面里的字体变清晰，变细用CSS怎么做？](#b52)
    * [如何修改chrome记住密码后自动填充表单的黄色背景？](#b53)
    * [font-style属性可以让它赋值为“oblique” oblique是什么意思？](#b54)
    * [css多列等高如何实现？](#b55)
    * [margin和padding分别适合什么场景使用？](#b56)
    * [zoom:1的清除浮动原理](#b57)
    * [请说出三种减低页面加载时间的方法](#b58)
    * [什么是CSS预处理器和后处理器？](#b59)
    * [解释下CSSsprites原理，优缺点](#b60)
    * [Quirks模式是什么？它和Standards模式有什么区别？](#b61)

*  三、[HTML5+CSS3](#c0)

    * [什么是HTML5？](#c1)
    * [HTML5为什么只需要写<!Doctypehtml>](#c2)
    * [请写出至少5个html5新增的标签，并说明其语义和应用场景](#c3)
    * [html5有哪些新特性](#c4)
    * [HTML5引入什么新的表单属性？](#c5)
    * [HTML5废弃了哪些HTML4标签](#c6)
    * [哪些浏览器支持HTML5？](#c7)
    * [HTML5的页面结构同HTML4或者更前的HTML有什么区别？](#c8)
    * [除了audio和video，HTML5还有哪些媒体标签？](#c9)
    * [什么是响应式布局](#c10)
    * [响应式布局该怎么设计](#c11)
    * [响应式布局有哪些优点和缺点](#c12)
    * [请解释一下CSS3的Flexbox（弹性盒布局模型），以及适用场景？](#c13)
    * [什么的媒体查询？](#c14)
    * [常见媒体查询有哪些？](#c15)
    * [如何编写媒体查询？](#c16)
    * [新的HTML5文档类型和字符集是？](#c17)
    * [HTML5中如何嵌入音频？](#c18)
    * [HTML5的Canvas元素有什么用？](#c19)
    * [HTML5存储类型有什么区别？](#c20)
    * [label标签的作用、应用](#c21)
    * [如何处理HTML5新标签的浏览器兼容问题？](#c22)
    * [如何实现浏览器内多个标签页之间的通信](#c23)
    * [HTML5应用程序缓存和浏览器缓存有什么区别](#c24)
    * [webSocket如何兼容低浏览器](#c25)
    * [HTML5的离线储存怎么使用，工作原理能不能解释一下？](#c26)
    * [浏览器是怎么对HTML5的离线储存资源进行管理和加载的呢](#c27)
    * [CSS3有哪些新特性？](#c28)
    * [CSS3的属性为什么要带前缀](#c29)
    * [CSS3的rem单位与传统em的区别](#c30)
    * [CSS3新增伪类有那些？](#c31)
    * [before和after中双冒号和单冒号有什么区别？](#c32)
*  四、[JavaScript](#d0)
    * [document。write和innerHTML的区别](#d1)
    * [javascript怎样添加、移除、移动、复制、创建节点](#d2)
    * [简述列举文档对象模型DOM里document的常用的查找访问节点的方法](#d3)
    * [请叙述下js的基本数据类型](#d4)
    * [介绍js有哪些内置对象？](#d5)
    * [什么是window对象什么是document对象](#d6)
    * [列举浏览器对象模型BOM里常用的至少4个对象，并列举window对象的常用方法至少5个](#d7)
    * [BOM对象有哪些，列举window对象？](#d8)
    * [谈谈对this指针的理解，可以列举几种使用情况？](#d9)
    * [null和undefined的区别？](#d10)
    * [阐述下==和===的区别](#d11)
    * [面向对象的理解？](#d12)
    * [面向对象的三大特点是什么？](#d13)
    * [new操作符具体干了什么呢](#d14)
    * [请解释一下JavaScript的同源策略](#d15)
    * [如何解决跨域问题](#d16)
    * [eval是做什么的？](#d17)
    * [已知ID的Input输入框，希望获取这个输入框的输入值，怎么做？](#d18)
    * [javascript函数有重载这个概念呢？](#d19)
    * [如何判断一个js对象是否是Array，最准确的方法是](#d20)
    * [javascript的typeof返回哪些数据类型](#d21)
    * [js如何获得一个DOM元素的绝对位置](#d22)
    * [同步和异步的区别](#d23)
    * [谈谈JavaScript的作用域和作用域链](#d24)
    * [什么是usestrict使用它区别是什么？](#d25)
    * [call和apply的区别是什么？](#d26)
    * [在Javascript中什么是伪数组？如何将伪数组转化为标准数组？](#d27)
    * [Javascript中callee和caller的作用？](#d28)
    * [JavaScript中的变量声明提升？](#d29)
    * [请解释一下什么是闭包](#d30)
    * [解释下JavaScript原型，原型链](#d31)
    * [描述一下cookies，sessionStorage和localStorage的区别](#d32)
    * [什么是Cookie隔离？](#d33)
    * [在JavaScript中，常用的绑定事件的方法有哪些？](#d34)
    * [请解释什么是事件代理](#d35)
    * [javascript的事件流模型都有什么？](#d36)
    * [事件是？IE与火狐的事件机制有什么区别？如何阻止冒泡？](#d37)
    * [谈谈对JSON的理解](#d38)
    * [请你谈谈Cookie的弊端](#d39)
    * [Ajax读取一个XML文档并进行解析的实例](#d40)
    * [ajax的readystate有5个状态，每个状态表示什么？](#d41)
    * [Ajax有哪些好处和弊端？](#d42)
    * [AJAX应用和传统Web应用有什么不同](#d43)
    * [Flash、Ajax各自的优缺点，在使用中如何取舍？](#d44)
    * [GET和POST的区别，何时使用POST？](#d45)
    * [如何判断当前脚本运行在浏览器还是node环境中？](#d46)
    * [JS模块的封装方法，比如怎样实现私有变量，不能直接赋值，只能通过公有方法](#d47)
    * [JavaScript的值类型和引用类型](#d48)
    * [阐述下split与join的区别](#d49)
    * [JavaScript中，有一个函数，执行时对象查找时，永远不会去查找原型，这个函数是？](#d50)
    * [阐述下什么是块级作用域](#d51)
    * [HTTP状态消息200、302、304、403、404、500分别表示什么](#d52)
    * [js延迟加载的方式有哪些？](#d53)
    * [requireJS的核心原理是什么？](#d54)
    * [内存泄露是什么，哪些操作会造成内存泄漏？](#d55)
    * [AMD、CMD规范区别？](#d56)
    * [如何在页面上实现一个圆形的可点击区域？](#d57)
    * [谈谈对ES6相对ES5增加了哪些扩展](#d58)
    * [ECMAScript和JavaScript的关系](#d59)
    * [ECMAScript6怎么写class，为什么会出现class这种东西](#d60)
    * [ECMAScript6引入了let它与传统的var有何区别？](#d61)
    * [谈谈对ES6const的理解](#d62)
    * [ES6中Object.is() 与原来的比较操作符“ ===”、“ ==”的区别？](#d63)
* 五、[jQuery](#e0)
    * [什么是jQuery？](#e1)
    * [body中的onload函数和jQuery中jquerydocument。ready有什么区别？](#e2)
    * [阐述下jquery。extend与jquery。fn。extend的区别？](#e3)
    * [阐述下bind，live，delegate的区别](#e4)
    * [怎样才能jQuery对象与DOM对象之间的转换](#e5)
    * [$(this)和this关键字在jQuery中有何不同？](#e6)
    * [jquery中get（）提交和post（）提交有区别吗？](#e7)
    * [jquery和javascript有什么区别？](#e8)
    * [jQuery与jQueryUI有啥区别？](#e9)
    * [jQuery中jquery（′class′）和jQuery中jquery('div.class')哪个效率更高？](#e10)
    * [jQuery中detach（）和remove（）方法的区别是什么](#e11) 
    * [jQuery的slideUp动画，如果目标元素是被外部事件驱动，当鼠标快速地连续触发外部元素事件，动画会滞后的反复执行，该如何处理呢](#e12)
    * [在一个jQuery事件处理程序里返回了false会怎样？](#e13)
    * [哪种方式更高效：document.getElementbyId(“myId”) 还是 $(“#myId”)？](#e14)
    * [使用CDN加载jQuery库的主要优势是什么](#e15)
    * [叙述下jQuery的特点](#e16)
